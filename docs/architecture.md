...
| [T3 Code remote access](architecture/t3-code.md) | T3 web app in JupyterLab, server lifecycle, providers, and desktop connection |
...
- T3 Code: automatically started coding-agent web app in JupyterLab and desktop-accessible server on port 3773
